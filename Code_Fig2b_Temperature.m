clear;
load Data_Fig2b_1to10Sep2020.mat;

Temperature=Fig2bTemperature;
Xy=Fig2bTime;
...
X=table(datestr(Xy,'yyyy-mm-dd'));     % 'dd-mmm-yyyy' to '11-Oct-2019'
...
T0=floor(T_min);
if T_min-floor(T_min)>=0.5     % Temperature grids, step: 0.5℃
   T0=floor(T_min)+0.5;
end
T1=ceil(T_max);
...
colorrange=T0:0.5:T1;           % Range of temperature in contourf map
...
figure('position',[100 10 700 N_subfig*75]);  % tue the hight of figure according to the number of sub-figures.
if N_subfig<5
